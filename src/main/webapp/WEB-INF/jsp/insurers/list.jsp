...
<!--https://www.jqueryscript.net/table/jQuery-Table-Pagination-For-Materialize.html -->
    ...
    <div class="row">
        ...
        <a href="${urlHome}insurers/add" class="float-md-left" >Add New Insurer </a>
        ...
        <table id="jtable"  class="table  table-hover table-sm"
            ...
            <c:forEach var="insurer" items="${insurerList}">
                <tr>
                    ...
                    <td> <spring:url
                            value="/insurers/${insurer.id}/delete" var="deleteUrl" />
                            <spring:url
                            value="/insurers/${insurer.id}/update" var="updateUrl" />
